...
const Search = () => {
    ...
    const handleSubmit = (event)=>{
        ...
        axios.get(`https://cors-anywhere.herokuapp.com/http://api.musixmatch.com/ws/1.1/track.search?q_track=${tracktitle}&page_size=10&page=1&s_track_rating=desc&apikey=46a908cae9e6fe663a1fe8ef339f08f6`)
        .then(res=>{
            dispatch({
                type:'SEARCH_SONG',
