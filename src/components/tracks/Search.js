...
const Search = () => {
    ...
    const handleSubmit = (event)=>{
        ...
        axios.get(`https://cors-anywhere.herokuapp.com/http://api.musixmatch.com/ws/1.1/track.search?q_track=${tracktitle}&page_size=10&page=1&s_track_rating=desc&apikey=${process.env.REACT_APP_APIKEY}`)
        .then(res=>{
            dispatch({
                type:'SEARCH_SONG',
